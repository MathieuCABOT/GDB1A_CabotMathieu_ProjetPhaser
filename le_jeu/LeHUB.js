...
create () {
    ...
    door1 = this.add.sprite(50, 500,'door1'); 
    door2 = this.add.sprite(1950, 500,'door2'); 
    door3 = this.add.sprite(1000, 50,'door3');
...
//____________________________________________________________________________________________
    ...
    this.add.image(300,200,'arbre');
    this.add.image(700,200,'arbre');
    this.add.image(1300,200,'arbre');
    this.add.image(1700,200,'arbre');
